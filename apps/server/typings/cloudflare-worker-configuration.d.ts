/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./typings/cloudflare-worker-configuration.d.ts` (hash: ba2d635c5c17a903ddfc8561921f73d9)
// Runtime types generated with workerd@1.20260611.1 2026-06-05 nodejs_compat
interface __BaseEnv_Env {
	i7eo_dev_shopify_app_kv: KVNamespace;
	i7eo_dev_shopify_app_r2: R2Bucket;
	i7eo_dev_shopify_app_d1: D1Database;
	i7eo_dev_shopify_app_hyperdrive: Hyperdrive;
	i7eo_dev_shopify_app_queue: Queue;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../src/app/runtime/isolate/cloudflare/index");
	}
